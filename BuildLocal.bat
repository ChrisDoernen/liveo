...
nunit3-console.exe ../../../../Service/LivestreamApp.Apps.Test/bin/Release/LivestreamApp.Apps.Test.dll
nunit3-console.exe ../../../../Service/LivestreamApp.Server.Test/bin/Release/LivestreamApp.Server.Test.dll
nunit3-console.exe ../../../../Service/LivestreamApp.Shared.Test/bin/Release/LivestreamApp.Shared.Test.dll
